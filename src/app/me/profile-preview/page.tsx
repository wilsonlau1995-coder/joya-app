...
import { ArrowLeft, ArrowLeftRight, Heart } from "lucide-react";
...
export default function ProfilePreviewPage() {
  ...
  const photos: Photo[] = [
    { id: "1", url: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=600&h=800&fit=crop" },
    { id: "2", url: "https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=600&h=800&fit=crop" },
  ];
  ...
  const gender = "male";
  const birthday = "1998-10-01";
  const region = "Shanghai";
  const bio = "nice to meet you guys";
